...
## Cambios
- Preparar el escudo de ToNOI como favicon cuadrado, con fondo blanco y compatible con Google, incluyendo los tamaños habituales.
...
## Detalles técnicos
- El proyecto ya tiene un PNG cuadrado de 500 × 500; se generará desde él una versión optimizada de 64 × 64 píxeles con fondo blanco.
- La referencia actual apunta a `/logo.png`; se sustituirá por una declaración explícita al nuevo favicon y se eliminará el `.ico` antiguo para evitar que navegadores o buscadores sigan usándolo.
